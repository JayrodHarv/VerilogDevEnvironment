...
module ProjectPart1_test(
    ...
    initial begin
        $dumpfile("src/ProjectPart1/waves/dump.vcd");
        $dumpvars(0, ProjectPart1_test);

        file_descriptor = $fopen("src/ProjectPart1/logs/ProjectPart1.log", "w"); // opens a log file to write test logs to
